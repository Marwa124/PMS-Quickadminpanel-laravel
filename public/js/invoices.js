 ...
 * 
 * ***/
function get_related_moduleName(val, invoice) {
    var url = '/admin/finance/invoices/getmodule';
...
function getitem(val) {
    var url = '/admin/finance/invoices/getinvoiceitem';
...
function get_taxes_dropdown_template() {
    var url = '/admin/finance/invoices/get_taxes';
    jQuery.ajaxSetup({
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
