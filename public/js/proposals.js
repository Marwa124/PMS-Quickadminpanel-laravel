    ...
    if (data.new_itmes_id != '' && data.qty > data.total_qty) {
        ...
        get_taxes_dropdown_template().done(function (tax_dropdown) {
            ...
            if (data.selling_Price != 0) {
                ...
                table_row += '<td class="total_cost_price"><input type="number" name="items[' + item_key + '][total_cost_price]" value="' + data.total_cost_price + '" onblur="calculate_total_edit();" onchange="calculate_total_edit();" total_cost_price placeholder="Total Cost Price" class="form-control " readonly/></td>';
                table_row += '<td class="margin"><input type="number" name="items[' + item_key + '][margin]" value="' + data.margin + '" onblur="calculate_total_edit();" onchange="calculate_total_edit();" data-edit-margin placeholder="Margin" class="form-control "/></td>';
                table_row += '<td class="rateee"> <input type="number" data-parsley-type="number"  onblur="calculate_total_edit();" onchange="calculate_total_edit();" name="items[' + item_key + '][selling_price]" value="' + data.selling_Price + '" class="form-control " readonly> </td>';
                table_row += '<td class="ratex"><input type="number" data-parsley-type="text" name="items[' + item_key + '][delivery]" value="' + data.delivery + '" class="form-control " ></td>';
            } else {
