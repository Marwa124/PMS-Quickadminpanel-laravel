                ...
                @if($attachments)
                    ...
                    @foreach($attachments as $attachment)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('finance.admin.transfers.download.attach',$attachment->id)}}" target="_blank"><i
                                        class="fas fa-download"></i></a>
                                <a href="{{route('finance.admin.transfers.view.attach',$attachment->id)}}" target="_blank"><i
