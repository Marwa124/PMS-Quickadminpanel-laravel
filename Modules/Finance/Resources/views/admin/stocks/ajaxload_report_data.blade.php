    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <a class="btn btn-danger mr-3" href="{{route('finance.admin.stocks.pdf',$id)}}" title="pdf">
...
@elseif(isset($start) && $start != null)
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                <h3>   {{ trans('cruds.stock.fields.report_list') }}</h3>
                <a class="btn btn-danger mr-3" href="{{route('finance.admin.stocks.pdf_period',[$start,$end])}}"
                   title="pdf">
                    <i class="fa fa-file-pdf  " aria-hidden="true"></i>
                </a>
            </div>
