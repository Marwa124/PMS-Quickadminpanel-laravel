...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("finance.admin.payment_received.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transaction_id') ? 'is-invalid' : '' }}" type="text" name="transaction_id"
                       id="transaction_id" value="{{ $transaction_id }}" readonly>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('payment_method') ? 'is-invalid' : '' }}" name="payment_method" id="payment_method">
                    @foreach($payment_methods as $id => $payment_method)
                        <option value="{{ $id }}" {{ old('payment_method') == $id ? 'selected' : '' }}>{{ $payment_method }}</option>
                    @endforeach
                </select>
