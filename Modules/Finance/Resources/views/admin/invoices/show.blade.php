        ...
        <div class="card-body">
          <div class="row mb-4">
            ...
            <div class="col-sm-4">
              ...
              <div>{{ trans('cruds.invoice.fields.due_date') }} : {!! $invoice->due_date .' '. $overdue ?? ''  !!}</div>
          ...
          <div class="row mb-4">
            ...
            <div class="col-sm-4">
                    ...
                    <div>{{ trans('cruds.invoice.fields.client') }} : {{$invoice->client->name}} </div>
                    <div>{{ trans('cruds.invoice.fields.companyaddress') }} : {{$invoice->client->address}}</div>
                    <div>{{ trans('cruds.invoice.fields.companyphone') }}: {{$invoice->client->phone}} </div>
