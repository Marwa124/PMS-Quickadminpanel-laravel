                ...
                @if($attachments)
                    ...
                    @foreach($attachments as $attachment)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('finance.admin.expenses.download.attach',$attachment->id)}}" target="_blank"><i
                                        class="fas fa-download"></i></a>
                                <a href="{{route('finance.admin.expenses.view.attach',$attachment->id)}}" target="_blank"><i
