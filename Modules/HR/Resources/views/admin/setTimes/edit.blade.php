...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("hr.admin.set-times.update", [$setTime->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.setTime.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $setTime->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('in_time') ? 'is-invalid' : '' }}" type="time" name="in_time" id="in_time" value="{{ old('in_time', $setTime->in_time) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('out_time') ? 'is-invalid' : '' }}" type="time" name="out_time" id="out_time" value="{{ old('out_time', $setTime->out_time) }}">
            ...
            <div class="form-group">
              ...
              <input class="form-control {{ $errors->has('allow_clock_in_late') ? 'is-invalid' : '' }}" type="time" name="allow_clock_in_late" id="allow_clock_in_late" value="{{ old('allow_clock_in_late', $setTime->allow_clock_in_late) }}">
          ...
          <div class="form-group">
              ...
              <input class="form-control {{ $errors->has('allow_leave_early') ? 'is-invalid' : '' }}" type="time" name="allow_leave_early" id="allow_leave_early" value="{{ old('allow_leave_early', $setTime->allow_leave_early) }}">
