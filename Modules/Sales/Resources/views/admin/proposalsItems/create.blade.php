    ...
    <div class="card-body">
        <form method="POST" action="{{ route("sales.admin.proposals-items.store") }}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input class="form-control {{ $errors->has('group_name') ? 'is-invalid' : '' }}" type="text"
                name="group_name" id="group_name" value="{{ old('group_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('brand') ? 'is-invalid' : '' }}" type="text" name="brand" id="brand"
                    value="{{ old('brand', '') }}">
                @if($errors->has('brand'))
                <div class="invalid-feedback">
                    {{ $errors->first('brand') }}
            ...
            {{-- <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('delivery') ? 'is-invalid' : '' }}" type="text" name="delivery"
                    id="delivery" value="{{ old('delivery', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('part') ? 'is-invalid' : '' }}" type="text" name="part" id="part"
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_cost') ? 'is-invalid' : '' }}" type="number" name="unit_cost"
                    id="unit_cost" value="{{ old('unit_cost', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('margin') ? 'is-invalid' : '' }}" type="number" name="margin"
                    id="margin" value="{{ old('margin', '') }}" step="1">
            ...
            {{-- <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('selling_price') ? 'is-invalid' : '' }}" type="number"
                    name="selling_price" id="selling_price" value="{{ old('selling_price', '') }}" step="0.01">
            ...
            {{-- <div class="form-group">
                <label class="required"
                    for="total_cost_price">{{ trans('cruds.proposalsItem.fields.total_cost_price') }}</label>
                <input class="form-control {{ $errors->has('total_cost_price') ? 'is-invalid' : '' }}" type="number"
                    name="total_cost_price" id="total_cost_price" value="{{ old('total_cost_price', '') }}" step="0.01"
                    required>
            ...
            {{-- <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tax_rate') ? 'is-invalid' : '' }}" type="number" name="tax_rate"
                    id="tax_rate" value="{{ old('tax_rate', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tax_name') ? 'is-invalid' : '' }}" type="text" name="tax_name"
                    id="tax_name" value="{{ old('tax_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tax_total') ? 'is-invalid' : '' }}" type="number" name="tax_total"
                    id="tax_total" value="{{ old('tax_total', '') }}" step="0.01">
            ...
            {{-- <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tax_cost') ? 'is-invalid' : '' }}" type="number" name="tax_cost"
                    id="tax_cost" value="{{ old('tax_cost', '') }}" step="0.01">
            ...
            {{-- <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('order') ? 'is-invalid' : '' }}" type="number" name="order"
                    id="order" value="{{ old('order', '') }}" step="1">
                @if($errors->has('order'))
                <div class="invalid-feedback">
                    {{ $errors->first('order') }}
                </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit') ? 'is-invalid' : '' }}" type="text" name="unit" id="unit"
...
<div class="modal fade" id="taxModal" tabindex="-1" role="dialog" aria-labelledby="taxModal" aria-hidden="true">
    <div class="modal-dialog modal-primary" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"> {{ trans('global.create') }} {{ trans('cruds.taxRate.title_singular') }}
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            ...
            <div class="modal-body">
                <form method="POST" action="#" id="form3">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('rate_percent') ? 'is-invalid' : '' }}" type="number" name="rate_percent" id="rate_percent" value="{{ old('rate_percent', '') }}" step="0.01" min="0.01" required>
                     
                    </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="customgroupsubmit2">
                    {{ trans('global.save') }}</button>
            </div>
            </form>
        </div>
                        ...
                        return loader.file
                            .then(function (file) {
                                return new Promise(function (resolve, reject) {
                                    ...
                                    xhr.open('POST', '/admin/sales/proposals-items/ckmedia',
                                        true);
