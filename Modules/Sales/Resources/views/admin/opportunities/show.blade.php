            ...
            <div class="col-3">
                <div class="card">
                    ...
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link" id="v-pills-comments-tab"       data-toggle="pill" href="#v-pills-comments" role="tab" aria-controls="v-pills-comments" aria-selected="false">{{ trans('cruds.comment.title') }}<span class="float-right">   {{$opportunity->comments_with_replies && $opportunity->comments_with_replies()->count() > 0 ? $opportunity->comments_with_replies()->count() : ''}}</span></a>
                    ...
                    <div class="tab-pane fade" id="v-pills-comments" role="tabpanel" aria-labelledby="v-pills-comments-tab">
                        <div class="card"  >
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('sales.admin.opportunities.add_comment') }}" method="post" class="" enctype="multipart/form-data">
                                    @csrf
                                ...
                                @foreach($opportunity->comments as $comment)
                                    <div class="col-md-12 ml-1" style="margin-bottom: 40px;">
                                        ...
                                        <div class="replay" id="replay_{{$comment->id}}" style="display:{{$errors->has('replay_comment') ? 'block': 'none'}}" >
                                            ...
                                            <form action="{{ route('sales.admin.opportunities.add_comment') }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <input type="hidden" name="opportunity_id"    value="{{ $opportunity->id }}">
