...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("sales.admin.opportunities.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <select name="stages" id="stages" class="form-control select_box stages select2 {{ $errors->has('stages') ? 'is-invalid' : '' }}" style="width: 100%;" >
                    ...
                    <option value="C">Qualification (C)</option>
                      <option value="B">Needanalysis (B)</option>
                      <option value="B+">Proposal (B+)</option>
                      <option value="A">Negotation (A)</option>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('probability') ? 'is-invalid' : '' }}" type="number" name="probability" id="probability" value="{{ old('probability', '0') }}" min="0">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('nextactiondate') ? 'is-invalid' : '' }}" type="text" name="nextactiondate" id="nextactiondate" value="{{ old('nextactiondate') }}">
