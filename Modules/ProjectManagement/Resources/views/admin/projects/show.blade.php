                ...
                <span class="float-right ">
                    @can('project_create')
                        <a class="btn btn-secondary "
                           href="{{ route('projectmanagement.admin.projects.clone', $project->id) }}" id="clone"
                    ...
                    <a class="btn btn-danger mr-3"
                       href="{{route('projectmanagement.admin.projects.project_pdf',$project->id)}}" title="pdf">
            ...
            <div class="card">
                ...
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <a class="nav-link active" id="v-pills-details-tab" data-toggle="pill" href="#v-pills-details"
                       ...
                       aria-selected="true">{{trans('cruds.project.title_singular')}} {{trans('global.details')}}</a>
                    <a class="nav-link" id="v-pills-comments-tab" data-toggle="pill" href="#v-pills-comments" role="tab"
                       aria-controls="v-pills-comments" aria-selected="false">{{ trans('cruds.comment.title') }}<span
                                class="float-right">                     {{$project->comments_with_replies && $project->comments_with_replies()->count() > 0 ? $project->comments_with_replies()->count() : ''}}</span></a>
                    <a class="nav-link" id="v-pills-milestones-tab" data-toggle="pill" href="#v-pills-milestones"
                       role="tab" aria-controls="v-pills-milestones"
                       aria-selected="false">{{ trans('cruds.milestone.title') }} <span
                                class="float-right">              {{$project->milestones && $project->milestones()->count() > 0 ? $project->milestones()->count() : ''}}</span></a>
                    <a class="nav-link" id="v-pills-tasks-tab" data-toggle="pill" href="#v-pills-tasks" role="tab"
                       aria-controls="v-pills-tasks" aria-selected="false">{{ trans('cruds.task.title') }}<span
                                class="float-right">                              {{$project->tasks && $project->tasks()->count() > 0 ? $project->tasks()->count() : ''}}</span></a>
                    <a class="nav-link" id="v-pills-bugs-tab" data-toggle="pill" href="#v-pills-bugs" role="tab"
                       aria-controls="v-pills-bugs" aria-selected="false">{{ trans('cruds.bug.title') }}<span
                                class="float-right">                                 {{$project->bugs && $project->bugs()->count() > 0 ? $project->bugs()->count() : ''}}</span></a>
                    <a class="nav-link" id="v-pills-notes-tab" data-toggle="pill" href="#v-pills-notes" role="tab"
                       aria-controls="v-pills-notes" aria-selected="false">{{ trans('cruds.project.fields.notes') }}</a>
                    <a class="nav-link" id="v-pills-tickets-tab" data-toggle="pill" href="#v-pills-tickets" role="tab"
                       aria-controls="v-pills-tickets" aria-selected="false">{{ trans('cruds.ticket.title') }}<span
                                class="float-right">                        {{$project->tickets && $project->tickets()->count() > 0 ? $project->tickets()->count() : ''}}</span></a>
                    <a class="nav-link" id="v-pills-invoices-tab" data-toggle="pill" href="#v-pills-invoices" role="tab"
                       aria-controls="v-pills-invoices" aria-selected="false">{{ trans('cruds.invoice.title') }}<span
                                class="float-right">                     {{$project->invoices && $project->invoices()->count() > 0 ? $project->invoices()->count() : ''}}</span></a>
                    <a class="nav-link" id="v-pills-time_sheets-tab" data-toggle="pill" href="#v-pills-time_sheets"
                       role="tab" aria-controls="v-pills-time_sheets"
                       aria-selected="false">{{ trans('cruds.project.fields.time_sheet') }}<span
                                class="float-right">   {{$project->TimeSheet && $project->TimeSheet()->count() > 0 ? $project->TimeSheet()->count() : ''}}</span></a>
                    <a class="nav-link" id="v-pills-calendar-tab" data-toggle="pill" href="#v-pills-calendar" role="tab"
                       aria-controls="v-pills-calendar" aria-selected="false"
                       onclick="generateCalendar()">{{ trans('cruds.tasksCalendar.title') }}</a>
                    <a class="nav-link" id="v-pills-expenses-tab" data-toggle="pill" href="#v-pills-expenses" role="tab"
                       aria-controls="v-pills-expenses" aria-selected="false">{{ trans('cruds.expense.title') }} <span
                                class="float-right">                  {{$project->expenses && $project->expenses()->count() > 0 ? $project->expenses()->count() : ''}}</span></a>
                    <a class="nav-link" id="v-pills-activities-tab" data-toggle="pill" href="#v-pills-activities"
                       role="tab" aria-controls="v-pills-activities"
                       aria-selected="false">{{ trans('cruds.activities.title') }}<span
                                class="float-right">              {{$project->activities && $project->activities()->count() > 0 ? $project->activities()->count() : ''}}</span></a>
                </div>
            </div>
        </div>
        <div class="col-9">
            <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div class="col-sm-4 border-right ">
                                    ...
                                    <div class="pl-1 ">
                                        ...
                                        <div class="row"><p
                                                    class="font-bold col-md-6">{{ trans('cruds.project.fields.name') }}
                                                :</p> <span
                                                    class="col-md-6">{{ $project->{'name_'.app()->getLocale()} ?? ''  }}</span>
                                        </div>
                                        <div class="row"><p
                                                    class="font-bold col-md-6">{{ trans('cruds.project.fields.client') }}
                                                : </p><span
                                                    class="col-md-6">{{ $project->client && $project->client->name ? $project->client->name : '' }}</span>
                                        </div>
                                        <div class="row"><p
                                                    class="font-bold col-md-6">{{ trans('cruds.project.fields.start_date') }}
                                                :</p> <span class="col-md-6">{{ $project->start_date ?? '' }}</span>
                                        </div>
                                        <div class="row"><p
                                                    class="font-bold col-md-6">{{ trans('cruds.project.fields.end_date') }}
                                                :</p> <span class="col-md-6">{{ $project->end_date ?? '' }}</span></div>
                                        <div class="row"><p
                                                    class="font-bold col-md-6">{{ trans('cruds.project.fields.demo_url') }}
                                                :</p> <span class="col-md-6">{{ $project->demo_url ?? '' }}</span></div>
                                        <div class="row"><p
                                                    class="font-bold col-md-6">{{ trans('cruds.project.fields.project_status') }}
                                                : </p><span
                                                    class="col-md-6">{{ $project->project_status ? trans("cruds.status.".$project->project_status)  : '' }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4 border-right ">
                                    <div class=" pl-1">
                                        @if($project->TimeSheetOn->first())
                                            <div class="row"><p
                                                        class="font-bold col-md-6">{{ trans('cruds.project.fields.timer_status') }}
                                                    :</p> <span class="col-md-6"><a
                                                            class="btn-sm {{ $project->TimeSheetOn && $project->TimeSheetOn->first()->timer_status == 'on' ? 'btn-success' : 'btn-danger'}}"
                                                            style="color: #ffffff">{{trans('global.on')}}</a> <a
                                                            href="{{route('projectmanagement.admin.projects.update_project_timer',$project->id)}}"
                                                            class="btn btn-sm {{$project->TimeSheetOn && $project->TimeSheetOn->first()->timer_status == 'on' ? 'btn-danger' : 'btn-success'}}">{{$project->TimeSheetOn && $project->TimeSheetOn->first()->timer_status == 'on' ? trans('cruds.project.fields.stop_time') : trans('cruds.project.fields.start_time')}}</a></span>
                                            </div>
                                        @else
                                            <div class="row"><p
                                                        class="font-bold col-md-6">{{ trans('cruds.project.fields.timer_status') }}
                                                    :</p> <span class="col-md-6"><a class="btn-sm btn-danger"
                                                                                    style="color: #ffffff">{{trans('global.off')}}</a> <a
                                                            href="{{route('projectmanagement.admin.projects.update_project_timer',$project->id)}}"
                                                            class="btn btn-sm btn-success"> {{trans('cruds.project.fields.start_time')}}</a></span>
                                            </div>
                                        @endif
                                        <div class="row"><p
                                                    class="font-bold col-md-6">{{ trans('cruds.project.fields.estimate_hours') }}
                                                :</p> <span
                                                    class="col-md-6">{{ $project->estimate_hours ? $project->estimate_hours.' Hour' : '' }} </span>
                                        </div>
                                        <div class="row"><p
                                                    class="font-bold col-md-6">{{ trans('cruds.department.title_singular') }} {{ trans('cruds.project.fields.name') }}
                                                :</p> <span
                                                    class="col-md-6">{{ $project->department && $project->department->department_name ? $project->department->department_name : '' }}</span>
                                        </div>
                                        <div class="row"><p
                                                    class="font-bold col-md-6">{{ trans('cruds.project.fields.project_cost') }}
                                                :</p> <span class="col-md-6">{{ $project->project_cost?? 0 }} EGP</span>
                                        </div>
                                        <div class="row"><p class="font-bold col-md-5">{{ trans('global.assign_to') }}
                                                :</p> <span class="col-md-6">
                                                @if($project->accountDetails)
                                                    @forelse($project->accountDetails as $account)
                                                        <img class="img-thumbnail rounded-circle"
                                                             title="{{ $account->fullname }}" width="30%"
                                                             src="{{ $account->avatar ? str_replace('storage', 'storage', $account->avatar->getUrl()) : asset('images/default.png') }}"
                                ...
                                <div class="col-sm-4  ">
                                    <div class=" pl-1">
                                        <div class="row"><p
                                                    class="font-bold col-md-8"> {{trans('cruds.project.fields.total_expense')}}
                                                :</p> <span
                                                    class="col-md-4"> {{$total_expense ?? $total_expense }} {{settings('default_currency') ?? 'EGP'}} </span>
                                        </div>
                                        <div class="row"><p
                                                    class="font-bold col-md-8"> {{trans('cruds.project.fields.billable_expense')}}
                                                :</p> <span
                                                    class="col-md-4"> {{$billable_expense ?? $billable_expense }} {{settings('default_currency') ?? 'EGP'}}</span>
                                        </div>
                                        <div class="row"><p
                                                    class="font-bold col-md-8"> {{trans('cruds.project.fields.non_billable_expense')}}
                                                :</p> <span
                                                    class="col-md-4"> {{$not_billable_expense ?? $not_billable_expense }} {{settings('default_currency') ?? 'EGP'}}</span>
                                        </div>
                                        <div class="row"><p
                                                    class="font-bold col-md-8"> {{trans('cruds.project.fields.billed_expense')}}
                                                :</p> <span
                                                    class="col-md-4"> {{$paid_expense ?? $paid_expense }}  {{settings('default_currency') ?? 'EGP'}}</span>
                                        </div>
                                        <div class="row"><p
                                                    class="font-bold col-md-8"> {{trans('cruds.project.fields.unbilled_expense')}}
                                                :</p> <span
                                                        class="col-md-4"> {{ $billable_expense && $paid_expense && ($billable_expense - $paid_expense) ?? ($billable_expense - $paid_expense)}} {{settings('default_currency') ?? 'EGP'}}</span>
                                        </div>

                                        <h3 class="row"><p
                                                    class="font-bold col-md-6"> {{trans('cruds.project.fields.total_bill')}}
                                                :</p> <span
                                                    class="col-md-6"> {{$project->project_cost ?? $project->project_cost }} {{settings('default_currency') ?? 'EGP'}}</span>
                                        </h3>
                            ...
                            <div class="progress" style="width: auto">
                                <div class="progress-bar {{$project->calculate_progress >= 50 ? 'bg-success' : 'bg-danger'}}"
                                     role="progressbar" style="width: {{$project->calculate_progress}}%; "
                ...
                <div class="tab-pane fade" id="v-pills-milestones" role="tabpanel"
                     aria-labelledby="v-pills-milestones-tab">
                    <div class="card">
                        <div class="card-body">
                            <div class="nav flex-row nav-pills" id="v-pills-tab" role="tablist"
                                 aria-orientation="horizontal">
                                <a class="nav-link active" id="v-pills-milestone-tab" data-toggle="pill"
                                   href="#v-pills-milestone" role="tab" aria-controls="v-pills-milestone"
                                   aria-selected="true">{{ trans('cruds.milestone.title') }}</a>
                                @can('milestone_create')
                                    <a class="nav-link" id="v-pills-new_milestone-tab"
                                       href="{{route('projectmanagement.admin.milestones.create_project_milestone',$project->id)}}"
                                       role="tab" aria-controls="v-pills-new_milestone"
                                       aria-selected="false">New {{ trans('cruds.milestone.title_singular') }}</a>
                                @endcan
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade show active" id="v-pills-milestone" role="tabpanel"
                         aria-labelledby="v-pills-milestone-tab">
                        <div class="card">
                            <div>
                                                        ...
                                                        @canany(['milestone_edit' , 'milestone_assign_to','milestone_delete'])
                                                            <td>
                                                                ...
                                                                @can('milestone_delete')
                                                                    <form action="{{ route('projectmanagement.admin.milestones.destroy', $milestone->id) }}"
                                                                          method="POST"
                            ...
                            <div class="nav flex-row nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                @can('task_create')
                                    <a class="nav-link" id="v-pills-new_task-tab"
                                       href="{{route('projectmanagement.admin.tasks.create_project_task',$project->id)}}"
                                                ...
                                                @forelse($project->tasks as $key => $task)
                                                    <tr data-entry-id="{{ $task->id }}">
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="progress">
                                                                <div class="progress-bar {{$task->calculate_progress < 50 ? 'bg-danger':'bg-success'}}"
                                                                     role="progressbar"
                                                        ...
                                                        @canany(['task_edit' , 'task_assign_to' , 'task_delete'])
                                                            ...
                                                            <td>
                                                                ...
                                                                @can('task_delete')
                                                                    <form action="{{ route('projectmanagement.admin.tasks.destroy', $task->id) }}"
                                                                          method="POST"
                                                                          onsubmit="return confirm('{{ trans('global.areYouSure') }}');"
                                                                          style="display: inline-block;">
                                                                        <input type="hidden" name="_method"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="nav flex-row nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                @can('bug_create')
                                    <a class="nav-link" id="v-pills-new_bug-tab"
                                       href="{{route('projectmanagement.admin.bugs.create_project_bug',$project->id)}}"
                                       role="tab" aria-controls="v-pills-new_bug"
                                       aria-selected="false">New {{ trans('cruds.bug.title_singular') }}</a>
                                @endcan
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-pane fade" id="v-pills-notes" role="tabpanel" aria-labelledby="v-pills-notes-tab">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST"
                                  action="{{ route("projectmanagement.admin.projects.update_note", [$project->id]) }}"
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea
                                            class="form-control ckeditor {{ $errors->has('notes') ? 'is-invalid' : '' }}"
                                            name="notes" id="notes">{!! old('notes',$project->notes) !!}</textarea>
                                    @if($errors->has('notes'))
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="nav flex-row nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                @can('ticket_create')
                                    <a class="nav-link" id="v-pills-new_ticket-tab"
                                       href="{{route('projectmanagement.admin.tickets.create_project_ticket',$project->id) }}"
                                       role="tab" aria-controls="v-pills-new_ticket"
                                       aria-selected="false">New {{ trans('cruds.ticket.title_singular') }}</a>
                                @endcan
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <tr data-entry-id="{{ $ticket->id }}">
                                                        ...
                                                        @canany(['ticket_show' , 'ticket_edit' , 'ticket_delete'])
                                                            <td>
                                                                ...
                                                                @can('ticket_delete')
                                                                    <form action="{{ route('projectmanagement.admin.tickets.destroy', $ticket->id) }}"
                                                                          method="POST"
                                                                          onsubmit="return confirm('{{ trans('global.areYouSure') }}');"
                                                                          style="display: inline-block;">
                                                                        <input type="hidden" name="_method"
                ...
                <div class="tab-pane fade" id="v-pills-invoices" role="tabpanel" aria-labelledby="v-pills-invoices-tab">
                    <div class="card">
                        <div class="card-body">
                            <div class="nav flex-row nav-pills" id="v-pills-tab" role="tablist"
                                 aria-orientation="horizontal">
                                <a class="nav-link active" id="v-pills-invoice-tab" data-toggle="pill"
                                   href="#v-pills-invoice" role="tab" aria-controls="v-pills-invoice"
                                   aria-selected="true">{{ trans('cruds.invoice.title') }}</a>
                                {{--@can('invoice_create')--}}
                    ...
                    <div class="tab-pane fade show active" id="v-pills-invoice" role="tabpanel"
                                                    ...
                                                    <tr data-entry-id="{{ $invoice->id }}">
                                                        ...
                                                        @canany(['invoice_show' , 'invoice_edit' , 'invoice_delete'])
                                                            <td>
                                                                @can('invoice_show')
                                                                    <a class="btn btn-xs btn-primary"
                                                                       href="{{ route('finance.admin.invoices.show', $invoice->id) }}">
                                                                        {{ trans('global.view') }}
                                                                    </a>
                                                                @endcan
                                                                ...
                                                                @can('invoice_edit')
                                                                    <a class="btn btn-xs btn-info"
                                                                       href="{{ route('finance.admin.invoices.edit', $invoice->id) }}">
                                                                        {{ trans('global.edit') }}
                                                                    </a>
                                                                @endcan

                                                                @can('invoice_delete')
                                                                    <form action="{{ route('finance.admin.invoices.destroy', $invoice->id) }}"
                                                                          method="POST"
                                                                          onsubmit="return confirm('{{ trans('global.areYouSure') }}');"
                                                                          style="display: inline-block;">
                                                                        <input type="hidden" name="_method"
                ...
                <div class="tab-pane fade" id="v-pills-expenses" role="tabpanel" aria-labelledby="v-pills-expenses-tab">
                    <div class="card">
                        <div class="card-body">
                            <div class="nav flex-row nav-pills" id="v-pills-tab" role="tablist"
                                 aria-orientation="horizontal">
                                <a class="nav-link active" id="v-pills-expense-tab" data-toggle="pill"
                                   href="#v-pills-expense" role="tab" aria-controls="v-pills-expense"
                                   aria-selected="true">{{ trans('cruds.expense.title') }}</a>
                                @can('expense_create')
                                    <a class="nav-link" id="v-pills-new_expense-tab"
                                       href="{{route('finance.admin.expenses.project.create',$project->id) }}"
                                       role="tab" aria-controls="v-pills-new_expense"
                                       aria-selected="false">New {{ trans('cruds.expense.title_singular') }}</a>
                                @endcan
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade show active" id="v-pills-expense" role="tabpanel"
                         aria-labelledby="v-pills-expense-tab">
                        <div class="card">
                            <div>
                                <div class="card-header">
                                    ...
                                    <div class="table-responsive">
                                        <table id="datatable"
                                               class=" table table-bordered table-striped table-hover datatable datatable-expenses">
                                            <thead>
                                            <tr>
                                                <th>
                                            ...
                                            @if(isset($project->expenses))
                                                @foreach($project->expenses as $expense)
                                                    <tr data-entry-id="{{ $expense->id }}">
                                                        ...
                                                        <td>
                                                            @php
                                                                $data = $expense->hasMedia('attachments') ? trans('cruds.expenses.attach') : '';

                                                              $attachments = $expense->getMedia('attachments') ?? null;
                                                              $id = $expense->id;
                                                            @endphp
                                                            @include('projectmanagement::admin.projects.modal')
                                                        </td>
                                                        @canany(['invoice_show' , 'invoice_edit' , 'invoice_delete'])
                                                            <td>
                                                                @can('invoice_show')
                ...
                <div class="tab-pane fade" id="v-pills-time_sheets" role="tabpanel"
                     aria-labelledby="v-pills-time_sheets-tab">
                    <div class="card">
                        <div class="card-body">
                            <div class="nav flex-row nav-pills" id="v-pills-tab" role="tablist"
                                 aria-orientation="horizontal">
                                <a class="nav-link active" id="v-pills-time_sheet-tab" data-toggle="pill"
                                   href="#v-pills-time_sheet" role="tab" aria-controls="v-pills-time_sheet"
                                   aria-selected="true"
                                   onclick="displayTimesheet('time_sheet')">{{ trans('cruds.project.fields.time_sheet') }}</a>
                                @canany(['time_sheet_create' , 'time_sheet_edit'])
                                    <a class="nav-link " id="v-pills-new_time_sheet-tab" data-toggle="pill"
                                       href="#v-pills-new_time_sheet" role="tab" aria-controls="v-pills-new_time_sheet"
                                       aria-selected="true"
                                       onclick="displayTimesheet('new_time_sheet')">New {{ trans('cruds.project.fields.time_sheet') }}</a>
                                @endcanany
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade show active" id="v-pills-time_sheet" role="tabpanel"
                         aria-labelledby="v-pills-time_sheet-tab">
                        <div class="card">
                            <div>
                                <div class="card-header">
                                                    ...
                                                    <tr data-entry-id="{{ $timer->id }}">
                                                        ...
                                                        <td>
                                                            ...
                                                            @if( $timer->user->accountDetail)
                                                                ...
                                                                <img class="img-thumbnail rounded-circle"
                                                                     title="{{ $timer->user->accountDetail->fullname ?? $timer->user->name}}"
                                                                     width="50%"
                                                                     src="{{ $timer->user->accountDetail->avatar ? str_replace('storage', 'storage', $timer->user->accountDetail->avatar->getUrl()) : asset('images/default.png') }}"
                                                                     alt="{{ $timer->user->accountDetail->fullname ?? $timer->user->name }}">
                                                            @else
                                                                <img class="img-thumbnail rounded-circle"
                                                                     title="{{ $timer->user && $timer->user->name ?  $timer->user->name:  ''}}"
                                                                     width="50%" src="{{ asset('images/default.png') }}"
                                                                     alt="{{ $timer->user && $timer->user->name ?  $timer->user->name:  '' }}">
                                                        ...
                                                        <td>
                                                            <a href="{{ route('projectmanagement.admin.projects.show', $timer->project->id) }}"
                                                               title=" {{ trans('global.view') }}">
                                                                {{ $timer->project && $timer->project->{'name_'.app()->getLocale()} ? $timer->project->{'name_'.app()->getLocale()} : '' }}
                                                            </a>
                                                            @if($timer->edited_by)
                                                                <span class="small"
                                                                      style="color: red"> {{trans('global.edited')}}</span>
                                                            @endif
                                                        </td>
                                                        <td>
                                                        ...
                                                        @canany(['time_sheet_edit','time_sheet_delete'])
                                                            <td>
                                                                @can('time_sheet_edit')
                                                                    <input type="hidden" name="timesheets"
                                                                           id="timesheets"
                                                                           value="{{$project->TimeSheet}}">
                                                                    <a class="btn btn-xs btn-info tablinks"
                                                                       onclick="showEditTime('{{$timer->id}}')"
                                                                       data-id="{{$timer->id}}" id="edit_timesheet"
                                                                ...
                                                                @can('time_sheet_delete')
                                                                    <form action="{{route('projectmanagement.admin.time-sheets.destroy',$timer->id)}}"
                                                                          method="POST"
                                                                          onsubmit="return confirm('{{ trans('global.areYouSure') }}');"
                                                                          style="display: inline-block;">
                                                                        <input type="hidden" name="_method"
                    ...
                    @canany(['time_sheet_create' , 'time_sheet_edit'])
                        <div class="tab-pane fade " id="v-pills-new_time_sheet" role="tabpanel"
                             aria-labelledby="v-pills-new_time_sheet-tab">
                            <div class="card">
                                <div>
                                    <div class="card-header">
                                        <form method="POST"
                                              action="{{ route("projectmanagement.admin.time-sheets.store") }}"
                                              enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="col-12">
                                                <div class="col-6 float-left">
                                                    <div class="form-group">
                                                        <label class="required"
                                                               for="start_date">{{ trans('cruds.project.fields.start_date') }}</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="required"
                                                               for="end_date">{{ trans('cruds.project.fields.end_date') }}</label>
                                                ...
                                                <div class="col-6 float-right">
                                                    <div class="form-group">
                                                        <label class="required"
                                                               for="start_time">{{ trans('cruds.project.fields.start_time') }}</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="required"
                                                               for="end_time">{{ trans('cruds.project.fields.stop_time') }}</label>
                                                        <input class="form-control {{ $errors->has('end_time') ? 'is-invalid' : '' }}"
                                            ...
                                            <div class="form-group">
                                                <label class="required"
                                                       for="reason">{{ trans('cruds.leaveApplication.fields.reason') }}</label>
                                                <textarea
                ...
                <div class="tab-pane fade" id="v-pills-activities" role="tabpanel"
                    ...
                    <div class="card">
                        ...
                        <div class="tab-pane fade show active" id="v-pills-activity" role="tabpanel"
                                                    ...
                                                    <section class="year">
                                                        ...
                                                        <section>
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <a href="{{route('admin.users.show',$activity->user->id)}}">{{$activity->user && $activity->user->name ? $activity->user->name : ''}}</a> {{$activity->{'activity_'.app()->getLocale()} ?? ''}}
                                                                    <strong> {{$activity->{'value1_'.app()->getLocale()} ?? ''}} </strong>
                                                                </li>
                                                            </ul>
                                                        </section>
                                                    </section>
                ...
                <div class="tab-pane fade" id="v-pills-comments" role="tabpanel" aria-labelledby="v-pills-comments-tab">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('projectmanagement.admin.projects.add_comment') }}" method="post"
                                ...
                                <div class="col-lg-12 col-md-12" style="padding-bottom: 20px;">
                                    ...
                                    <label class="form-group "
                                           for="comment">{{ trans('cruds.comment.title_singular') }}</label>
                                    <textarea
                                ...
                                <div class="col-12 ">
                                    <button type="submit"
                                            class="btn btn-primary float-right">{{ trans('global.save') }}</button>
                                </div>
                            </form>
                            ...
                            @foreach($project->comments as $comment)
                                <div class="col-md-12 ml-1" style="margin-bottom: 40px;">
                                    <div class="col-md-12">
                                        <img class="img-thumbnail rounded-circle"
                                             title="{{ $comment->user && $comment->user->name ? $comment->user->name : '' }}"
                                             width="5%"
                                             src="{{ $comment->user && $comment->user->accountDetail ? str_replace('storage', 'storage', $comment->user && $comment->user->accountDetail ? $comment->user->accountDetail->avatar->getUrl() : '') : asset('images/default.png') }}"
                                             alt="{{ $comment->user && $comment->user->accountDetail && $comment->user->accountDetail->fullname ? $comment->user->accountDetail->fullname : '' }}">

                                        {{$comment->user && $comment->user->name ? $comment->user->name  : ''}}

                                        <strong> {!! $comment->comment !!}</strong>
                                        <a id="add-replay" onclick="addReplay('{{$comment->id}}')" type="button"
                                           class="mb-5">
                                    ...
                                    <div class="replay" id="replay_{{$comment->id}}"
                                         style="display:{{$errors->has('replay_comment') ? 'block': 'none'}}">

                                        <form action="{{ route('projectmanagement.admin.projects.add_comment') }}"
                                            ...
                                            <div class="col-lg-12 col-md-12" style="padding-bottom: 20px;">
                                                ...
                                                <label class="form-group "
                                                       for="replay_comment">{{ trans('cruds.ticket.fields.replay') }}</label>
                                                <textarea
                                                        class="form-control ckeditor {{ $errors->has('replay_comment') ? 'is-invalid' : '' }}"
                                                        name="replay_comment"
                                                        id="replay_comment">{!! old('replay_comment')!!}</textarea>

                                            </div>

                                            <div class="col-12 pb-5">
                                                <button type="submit" id="replaySubmitBtn"
                                                        class="btn btn-primary float-right">{{ trans('global.save') }}</button>
                                            </div>
                                        </form>
                                    </div>
                                ...
                                <div class="modal-info mr-1 mb-1 d-inline-block">
                                    <div class="modal fade text-left" id="replay_attach_{{ $comment->id }}"
