                                ...
                                <td>
                                    @if(!$trashed)
                                        ...
                                        @can('project_assign_to')
                                            ...
                                            <a class="btn btn-xs btn-success {{$project->department ? '' : 'disabled'}}"
                                               ...
                                               title="{{$project->department ? '' : 'add department to project'}}">
                                    ...
                                    @else
                                        @can('project_delete')
                                            ...
                                            <form action="{{ route('projectmanagement.admin.projects.forceDestroy', $project->id) }}"
                                                  method="POST"
                                                  onsubmit="return confirm('Milestones and Tasks In This Project Will Force Delete Too ..! \n{{ trans('global.areYouSure') }}');"
                                                  style="display: inline-block;">
                                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
