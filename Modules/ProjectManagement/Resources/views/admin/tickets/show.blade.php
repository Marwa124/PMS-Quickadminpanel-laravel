            ...
            <div class="col-md-10" style="padding: 30px">
                <div class="card">
                    <div class="row" style="font-size:16px;font-weight:bold;">
                        <div class="col-md-12">
                            <div class="card-header">Subject : {{ ucfirst($ticket->subject) }} <span class="float-right">{{ trans('cruds.ticket.fields.reporter') }} : {{ $ticket->reporterBy ? ($ticket->reporterBy->name ?? '') : ''}}</span></div>
